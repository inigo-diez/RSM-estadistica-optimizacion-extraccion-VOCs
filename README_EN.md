...
#### Figures — `Y1_diagnosticos.png` … `Y9_diagnosticos.png`

| Y₁ | Y₂ | Y₃ |
|:--:|:--:|:--:|
| ![Diagnostics Y1](Graficos/Y1_diagnosticos.png) | ![Diagnostics Y2](Graficos/Y2_diagnosticos.png) | ![Diagnostics Y3](Graficos/Y3_diagnosticos.png) |

| Y₄ | Y₅ | Y₆ |
|:--:|:--:|:--:|
| ![Diagnostics Y4](Graficos/Y4_diagnosticos.png) | ![Diagnostics Y5](Graficos/Y5_diagnosticos.png) | ![Diagnostics Y6](Graficos/Y6_diagnosticos.png) |

| Y₇ | Y₈ | Y₉ |
|:--:|:--:|:--:|
| ![Diagnostics Y7](Graficos/Y7_diagnosticos.png) | ![Diagnostics Y8](Graficos/Y8_diagnosticos.png) | ![Diagnostics Y9](Graficos/Y9_diagnosticos.png) |

2×2 residual diagnostics panel per response, generated after the quadratic OLS fit:
- **Q-Q plot**: tests residual normality via the Shapiro-Wilk test; points should align on the reference line.
- **Residuals vs fitted**: detects heteroscedasticity or uncaptured residual structure; the ideal pattern is random and centred at zero.
- **Cook's distance**: identifies influential experiments (threshold 4/n); values above the threshold merit review.
- **Standardised residuals**: flags outliers (|z| > 2) that may distort the fit.
...
└── Graficos/
    ...
    ├── Y[1-9]_diagnosticos.png   ← Residual diagnostics (Q-Q, Cook, etc.)
