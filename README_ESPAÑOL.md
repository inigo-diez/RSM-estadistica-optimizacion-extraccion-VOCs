...
![Y5 Indol — Superficies 3D y contornos](RSM_Resultados/Y5_Indol_Superficies.png)
...
![Y5 Indol — Gráfico de interacción x₁×x₂](RSM_Resultados/Y5_Indol_Interaccion.png)
...
| Y₁ | Y₂ | Y₃ |
|:--:|:--:|:--:|
| ![Pareto Y1](RSM_Resultados/Y1_Pareto.png) | ![Pareto Y2](RSM_Resultados/Y2_Pareto.png) | ![Pareto Y3](RSM_Resultados/Y3_Pareto.png) |

| Y₄ | Y₅ | Y₆ |
|:--:|:--:|:--:|
| ![Pareto Y4](RSM_Resultados/Y4_Pareto.png) | ![Pareto Y5](RSM_Resultados/Y5_Pareto.png) | ![Pareto Y6](RSM_Resultados/Y6_Pareto.png) |

| Y₇ | Y₈ | Y₉ |
|:--:|:--:|:--:|
| ![Pareto Y7](RSM_Resultados/Y7_Pareto.png) | ![Pareto Y8](RSM_Resultados/Y8_Pareto.png) | ![Pareto Y9](RSM_Resultados/Y9_Pareto.png) |
...
| Y₁ | Y₂ | Y₃ |
|:--:|:--:|:--:|
| ![Superficies Y1](RSM_Resultados/Y1_Superficies.png) | ![Superficies Y2](RSM_Resultados/Y2_Superficies.png) | ![Superficies Y3](RSM_Resultados/Y3_Superficies.png) |

| Y₄ | Y₅ | Y₆ |
|:--:|:--:|:--:|
| ![Superficies Y4](RSM_Resultados/Y4_Superficies.png) | ![Superficies Y5](RSM_Resultados/Y5_Superficies.png) | ![Superficies Y6](RSM_Resultados/Y6_Superficies.png) |

| Y₇ | Y₈ | Y₉ |
|:--:|:--:|:--:|
| ![Superficies Y7](RSM_Resultados/Y7_Superficies.png) | ![Superficies Y8](RSM_Resultados/Y8_Superficies.png) | ![Superficies Y9](RSM_Resultados/Y9_Superficies.png) |
...
![Predicho vs Observado — 9 respuestas](RSM_Resultados/PredVsObs_Todas.png)
...
![Fase 6 — Puntos críticos y análisis Hessiano](RSM_Resultados/Fase6_Hessianos.png)
...
![Fase 7 — Deseabilidades individuales en el óptimo](RSM_Resultados/Fase7_Deseabilidades.png)
...
![Fase 7 — Localización del óptimo global multirrespuesta](RSM_Resultados/Fase7_Optimo_Global.png)
...
![Fase 7 — Análisis de sensibilidad del óptimo](RSM_Resultados/Fase7_Sensibilidad.png)
...
![Deseabilidad por experimento — original vs límites ampliados](RSM_Resultados/Desirabilidad_por_Experimento.png)
